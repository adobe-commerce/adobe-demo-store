...
`,w=async(e,a=4)=>{const r=[],c=i();try{const t=await _($,{variables:{phrase:e,size:a}});if(!t.data.productSearch.items)return{pageInfo:c,products:r};const{page_info:n,items:o}=t.data.productSearch;return o.forEach((u,m)=>{var l;if(!u)return;const s=y(u.product,m);s.urlKey=((l=u.productView)==null?void 0:l.urlKey)??"",r.push(s)}),{pageInfo:i(n),products:r}}catch(t){return console.error(t),{pageInfo:c,products:r}}};export{x as a,F as b,w as c,_ as f,b as g,I as r,v as s};
